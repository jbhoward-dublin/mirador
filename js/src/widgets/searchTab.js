      ...
      '<div class="search-results">',
        ...
        '<label for="search-within-selector">{{t "searchLabelSelect"}}</label>',
          ...
          '<form id="search-within-form" class="js-perform-query">',
            ...
            '<a class="js-search-expand" style="display: block; margin: 0 0 5px 0">Search options <i style="color: green;" class="fa fa-plus-circle fa-lg fa-fw"></i></a>',
            '<div class="js-search-expanded" style="display: none;">',
              //'<input class="js-motivation" type="text" placeholder="motivation"/>',
              '<select class="js-motivation" name="motivation" style="min-width: 210px;">',
              ' <option value="supplementing">full text (default)</option>',
              ' <option value="describing">comments</option>',
              ' <option value="tagging">tags</option>',
              '</select>',
              '<input class="js-date" type="text" placeholder="date(s)"/>',
              '<input class="js-user" type="text" placeholder="user (email address)"/>',
            '</div>',
